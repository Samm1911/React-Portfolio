...
// export Porfolio Page component, which includes all the other components
export default function PortfolioPage() {
    ...
    // handlePageChange function, which takes the page as an argument and sets the page as current page
    const handlePageChange = (page) => setCurrentPage(page);

    return (
        <div className='body'>
            {/* render Header including Navbar and passing current page and the handlePageChange function */}
            <Header>
                {{
